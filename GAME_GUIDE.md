...
Stellar Hex is a turn-based 4X strategy game played on an infinite hex grid. You explore procedurally generated space, build structures, produce units, research technologies, and compete against AI opponents. The goal is to achieve victory through domination or economic supremacy.
